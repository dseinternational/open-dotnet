...
public class DateMonthOnlyTests
{
    ...
    [InlineData("9090-11")]
    public void Parse_valid_values_succeeds(string value) => _ = DateMonthOnly.Parse(value);
    ...
    {
        var month = DateMonthOnly.Parse(value);
    ...
    {
        var value = DateMonthOnly.Parse(a) - DateMonthOnly.Parse(b);
