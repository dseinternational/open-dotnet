...
[JsonSerializable(typeof(Measure<Completeness, SpeechSound>))]
[JsonSerializable(typeof(Measure<Completeness, WordId>))]
[JsonSerializable(typeof(Measure<Completeness>))]
[JsonSerializable(typeof(Measure<Count>))]
[JsonSerializable(typeof(Measure<Ratio>))]
[JsonSerializable(typeof(Measure<SpeechClarity, SentenceId>))]
...
[JsonSerializable(typeof(Observation<Amount>))]
...
[JsonSerializable(typeof(Observation<Completeness, SentenceId>))]
[JsonSerializable(typeof(Observation<Completeness, SpeechSound>))]
[JsonSerializable(typeof(Observation<Completeness, WordId>))]
[JsonSerializable(typeof(Observation<Completeness>))]
[JsonSerializable(typeof(Observation<Count>))]
[JsonSerializable(typeof(Observation<SpeechClarity, SentenceId>))]
[JsonSerializable(typeof(Observation<SpeechClarity, SpeechSound>))]
[JsonSerializable(typeof(Observation<SpeechClarity, WordId>))]
[JsonSerializable(typeof(Observation<SpeechClarity>))]
