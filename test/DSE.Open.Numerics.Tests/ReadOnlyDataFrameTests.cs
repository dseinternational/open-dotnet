...
public class ReadOnlyDataFrameTests : LoggedTestsBase
{
    ...
    public void IndexerGet()
    {
        ...
        var series2 = Series.Create([5, 4, 3, 2, 1]).AsReadOnly();
    ...
    public void SerializeDeserializeReflectedInt32()
    {
        ...
        var series2 = Series.Create([.. Enumerable.Range(0, 100)]).AsReadOnly();
    ...
    {
        var series1 = Series.Create([.. Enumerable.Range(5000, 50).Select(i => i / 333f), float.MinValue, float.MaxValue]).AsReadOnly();
        var series2 = Series.Create([.. Enumerable.Range(-77777, 50).Select(i => i / 333f), float.MinValue, float.MaxValue]).AsReadOnly();
    ...
    {
        var series1 = Series.Create([.. Enumerable.Range(500000, 50).Select(i => i / 333.3), double.MinValue, double.MaxValue]).AsReadOnly();
        var series2 = Series.Create([.. Enumerable.Range(-7777777, 50).Select(i => i / 333.3), double.MinValue, double.MaxValue]).AsReadOnly();
    ...
    public void SerializeDeserializeReflectedDateTime64Int64()
    {
        ...
        var series1 = Series.Create([DateTime64.Now, DateTime64.Now, DateTime64.Now]).AsReadOnly();
        var series2 = Series.Create([5L, 4L, 3L]).AsReadOnly();
    ...
    public void SerializeDeserializeReflectedDateMixed()
    {
        ...
        var series1 = Series.Create([DateTime64.Now, DateTime64.Now, DateTime64.Now]).AsReadOnly();
        var series2 = Series.Create([5L, 4L, 3L]).AsReadOnly();
        var series3 = Series.Create([186352.1111, 0.0000067, -6984135]).AsReadOnly();
        var series4 = Series.Create([(byte)1, (byte)2, (byte)3]).AsReadOnly();
