...
public class ReadOnlyDataFrameTests : LoggedTestsBase
{
    ...
    {
        var series1 = Vector.Create("series1", [1, 2, 3, 4, 5]).AsReadOnly();
        var series2 = Vector.Create("series2", [5, 4, 3, 2, 1]).AsReadOnly();
    ...
    {
        var series1 = Vector.Create("series1", [.. Enumerable.Range(0, 100)]).AsReadOnly();
        var series2 = Vector.Create("series2", [.. Enumerable.Range(0, 100)]).AsReadOnly();
    ...
    {
        var series1 = Vector.Create("series1", [.. Enumerable.Range(5000, 50).Select(i => i / 333f), float.MinValue, float.MaxValue]).AsReadOnly();
        var series2 = Vector.Create("series2", [.. Enumerable.Range(-77777, 50).Select(i => i / 333f), float.MinValue, float.MaxValue]).AsReadOnly();
    ...
    {
        var series1 = Vector.Create("series1", [.. Enumerable.Range(500000, 50).Select(i => i / 333.3), double.MinValue, double.MaxValue]).AsReadOnly();
        var series2 = Vector.Create("series2", [.. Enumerable.Range(-7777777, 50).Select(i => i / 333.3), double.MinValue, double.MaxValue]).AsReadOnly();
    ...
    public void SerializeDeserializeReflectedDateTime64Int64()
    {
        ...
        var series1 = Vector.Create("series1", [DateTime64.Now, DateTime64.Now, DateTime64.Now]).AsReadOnly();
        var series2 = Vector.Create("series2", [5L, 4L, 3L]).AsReadOnly();
    ...
    public void SerializeDeserializeReflectedDateMixed()
    {
        ...
        var series1 = Vector.Create("series1", [DateTime64.Now, DateTime64.Now, DateTime64.Now]).AsReadOnly();
        var series2 = Vector.Create("series2", [5L, 4L, 3L]).AsReadOnly();
        var series3 = Vector.Create("series3", [186352.1111, 0.0000067, -6984135]).AsReadOnly();
        var series4 = Vector.Create("series4", [(byte)1, (byte)2, (byte)3]).AsReadOnly();
