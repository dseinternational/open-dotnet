...
public class UpdateUsersTrackedTaggedUniquelyIdentifiedEntityTests
{
    ...
    public void Materialization_Ctor_DefaultTag_Throws()
    {
        _ = Assert.Throws<EntityDataInitializationException>(() =>
            new IntKeyFake(42, Guid.NewGuid(), default(Tag), DateTimeOffset.UtcNow, "alice", DateTimeOffset.UtcNow, "bob", s_sampleTimestamp));
    }
    ...
    [Fact]
    public void Implements_IUniquelyIdentifiedEntity_And_IUpdateUsersTracked()
    {
        var entity = new GuidKeyFake(s_tag);
    ...
    private sealed class GuidKeyFake : UpdateUsersTrackedTaggedUniquelyIdentifiedEntity<Guid>
    {
    ...
    private sealed class IntKeyFake : UpdateUsersTrackedTaggedUniquelyIdentifiedEntity<int>
    {
        ...
        public IntKeyFake(
            ...
            string? updatedUser,
            Timestamp? timestamp)
            : base(id, uniqueId, tag, created, createdUser, updated, updatedUser, timestamp)
        {
        }
    }
}
