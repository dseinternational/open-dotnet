...
public class UpdateUsersTrackedTitleDescriptionEventRaisingEntityTests
{
    ...
    [Fact]
    public void Implements_ITitled_IDescribed_IUpdateUsersTracked_IEventRaisingEntity()
    {
        var entity = new Fake("t", "d");
    ...
    private sealed class Fake : UpdateUsersTrackedTitleDescriptionEventRaisingEntity<Guid>
    {
