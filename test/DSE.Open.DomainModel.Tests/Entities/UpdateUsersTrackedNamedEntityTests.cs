...
public class UpdateUsersTrackedNamedEntityTests
{
    ...
    [Fact]
    public void Implements_INamed_And_IUpdateUsersTracked()
    {
    ...
    private sealed class Fake : UpdateUsersTrackedNamedEntity<Guid>
    {
