...
public class UpdateUsersTrackedUniquelyIdentifiedEventRaisingEntityTests
{
    ...
    [Fact]
    public void Implements_IUniquelyIdentified_IUpdateUsersTracked_IEventRaisingEntity()
    {
        var entity = new Fake();
    ...
    private sealed class Fake : UpdateUsersTrackedUniquelyIdentifiedEventRaisingEntity<Guid>
    {
        public Fake()
        {
        }
    ...
    private sealed class IntKeyFake : UpdateUsersTrackedUniquelyIdentifiedEventRaisingEntity<int>
    {
