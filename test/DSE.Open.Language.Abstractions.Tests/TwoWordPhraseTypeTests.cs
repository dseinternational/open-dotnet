...
public class TwoWordPhraseTypeTests
{
    [Theory]
    [MemberData(nameof(Tags))]
    public void Parse_valid_tags(string tagStr)
    {
        var tag = TwoWordPhraseType.Parse(tagStr, CultureInfo.InvariantCulture);
    ...
    public void Serialize_deserialize(string tagStr)
    {
        ...
        var deserialized = JsonSerializer.Deserialize<TwoWordPhraseType>(json);
