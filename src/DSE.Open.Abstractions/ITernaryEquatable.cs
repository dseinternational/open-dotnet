...
/// </summary>
/// <typeparam name="T">The type of the other value to compare with.</typeparam>
/// <remarks>
...
/// <see cref="IEqualityOperators{TSelf, TOther, Trilean}"/> explicitly and rely on users wanting that
...
public interface ITernaryEquatable<T>
{
    ...
    /// returns <see cref="Open.Trilean.Na"/> (either or both values are 'unknown').
    /// </returns>
