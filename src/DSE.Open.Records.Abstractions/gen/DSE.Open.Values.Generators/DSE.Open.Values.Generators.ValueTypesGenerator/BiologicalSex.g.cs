...
[global::System.ComponentModel.TypeConverter(typeof(global::DSE.Open.Values.ValueTypeConverter<BiologicalSex, global::DSE.Open.AsciiString>))]
public readonly partial struct BiologicalSex
{
    private readonly global::DSE.Open.AsciiString _value;

    private BiologicalSex(global::DSE.Open.AsciiString value, bool skipValidation = false)
    {
        if (!skipValidation)
        {
    ...
    public static bool TryFromValue(global::DSE.Open.AsciiString value, out BiologicalSex result)
    {
        if (IsValidValue(value))
        {
    ...
    public static BiologicalSex FromValue(global::DSE.Open.AsciiString value)
    {
        EnsureIsValidValue(value);
        return new(value, true);
    }

    public static explicit operator BiologicalSex(global::DSE.Open.AsciiString value)
        => FromValue(value);

    static global::DSE.Open.AsciiString global::DSE.Open.IConvertibleTo<BiologicalSex, global::DSE.Open.AsciiString>.ConvertTo(BiologicalSex value)
        => (global::DSE.Open.AsciiString)value;

    public static implicit operator global::DSE.Open.AsciiString(BiologicalSex value)
    {
        return value._value;
    }
    ...
    // IEqualityOperators<BiologicalSex, BiologicalSex, bool>
    ...
    // ISpanParsable<BiologicalSex>

    public static BiologicalSex Parse(global::System.ReadOnlySpan<char> s, global::System.IFormatProvider? provider)
        => global::DSE.Open.Values.ValueParser.Parse<BiologicalSex, global::DSE.Open.AsciiString>(s, provider);

    public static BiologicalSex ParseInvariant(global::System.ReadOnlySpan<char> s)
    ...
    public static bool TryParse(
        ...
        => global::DSE.Open.Values.ValueParser.TryParse<BiologicalSex, global::DSE.Open.AsciiString>(s, provider, out result);
    ...
    // IParsable<BiologicalSex>

    public static BiologicalSex Parse(string s, global::System.IFormatProvider? provider)
        => global::DSE.Open.Values.ValueParser.Parse<BiologicalSex, global::DSE.Open.AsciiString>(s, provider);

    public static BiologicalSex Parse(string s)
        => Parse(s, default);

    public static BiologicalSex ParseInvariant(string s)
        => Parse(s, global::System.Globalization.CultureInfo.InvariantCulture);
    ...
    // IUtf8SpanParsable<BiologicalSex>

    public static BiologicalSex Parse(
        global::System.ReadOnlySpan<byte> utf8Source,
        global::System.IFormatProvider? provider)
        => global::DSE.Open.Values.ValueParser.Parse<BiologicalSex, global::DSE.Open.AsciiString>(utf8Source, provider);

    public static bool TryParse(
        global::System.ReadOnlySpan<byte> utf8Source,
        global::System.IFormatProvider? provider,
        out BiologicalSex result)
        => global::DSE.Open.Values.ValueParser.TryParse<BiologicalSex, global::DSE.Open.AsciiString>(utf8Source, provider, out result);
