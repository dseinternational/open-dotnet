...
[global::System.ComponentModel.TypeConverter(typeof(global::DSE.Open.Values.ValueTypeConverter<Gender, global::DSE.Open.AsciiString>))]
public readonly partial struct Gender
{
    private readonly global::DSE.Open.AsciiString _value;

    private Gender(global::DSE.Open.AsciiString value, bool skipValidation = false)
    {
        if (!skipValidation)
        {
    ...
    public static bool TryFromValue(global::DSE.Open.AsciiString value, out Gender result)
    {
        if (IsValidValue(value))
        {
    ...
    public static Gender FromValue(global::DSE.Open.AsciiString value)
    {
        EnsureIsValidValue(value);
        return new(value, true);
    }

    public static explicit operator Gender(global::DSE.Open.AsciiString value)
        => FromValue(value);

    static global::DSE.Open.AsciiString global::DSE.Open.IConvertibleTo<Gender, global::DSE.Open.AsciiString>.ConvertTo(Gender value)
        => (global::DSE.Open.AsciiString)value;

    public static implicit operator global::DSE.Open.AsciiString(Gender value)
    {
        return value._value;
    }
    ...
    public static Gender Parse(global::System.ReadOnlySpan<char> s, global::System.IFormatProvider? provider)
        => global::DSE.Open.Values.ValueParser.Parse<Gender, global::DSE.Open.AsciiString>(s, provider);

    public static Gender ParseInvariant(global::System.ReadOnlySpan<char> s)
    ...
    public static bool TryParse(
        ...
        global::System.IFormatProvider? provider,
        out Gender result)
        => global::DSE.Open.Values.ValueParser.TryParse<Gender, global::DSE.Open.AsciiString>(s, provider, out result);
    ...
    public static Gender Parse(string s, global::System.IFormatProvider? provider)
        => global::DSE.Open.Values.ValueParser.Parse<Gender, global::DSE.Open.AsciiString>(s, provider);
    ...
    public static Gender Parse(
        ...
        global::System.IFormatProvider? provider)
        => global::DSE.Open.Values.ValueParser.Parse<Gender, global::DSE.Open.AsciiString>(utf8Source, provider);

    public static bool TryParse(
        global::System.ReadOnlySpan<byte> utf8Source,
        global::System.IFormatProvider? provider,
        out Gender result)
        => global::DSE.Open.Values.ValueParser.TryParse<Gender, global::DSE.Open.AsciiString>(utf8Source, provider, out result);
