...
/// <summary>
/// Converts an <see cref="IList{T}"/> to and from an <see cref="IEnumerable{T}"/> of
    ...
    where T : IParsable<T>, IFormattable
{
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="ListToFormattableStringCollectionConverter{T}"/>
    ...
    /// <summary>
    /// Formats each element of the supplied list using the given format and format provider.
    /// </summary>
    /// <param name="set">The list to format. Must not be <see langword="null"/>.</param>
...
#pragma warning disable CA1000 // Do not declare static members on generic types
    public static IEnumerable<string> ToCollection(IList<T> set, string? format, IFormatProvider? formatProvider)
