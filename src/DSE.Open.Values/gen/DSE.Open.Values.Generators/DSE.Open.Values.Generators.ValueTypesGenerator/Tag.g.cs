...
[global::System.ComponentModel.TypeConverter(typeof(global::DSE.Open.Values.ValueTypeConverter<Tag, global::DSE.Open.AsciiString>))]
public readonly partial struct Tag
{
    private readonly global::DSE.Open.AsciiString _value;

    private Tag(global::DSE.Open.AsciiString value, bool skipValidation = false)
    {
        if (!skipValidation)
        {
    ...
    public static bool TryFromValue(global::DSE.Open.AsciiString value, out Tag result)
    {
        if (IsValidValue(value))
        {
    ...
    public static Tag FromValue(global::DSE.Open.AsciiString value)
    {
        EnsureIsValidValue(value);
        return new(value, true);
    }

    public static explicit operator Tag(global::DSE.Open.AsciiString value)
        => FromValue(value);

    static global::DSE.Open.AsciiString global::DSE.Open.IConvertibleTo<Tag, global::DSE.Open.AsciiString>.ConvertTo(Tag value)
        => (global::DSE.Open.AsciiString)value;

    public static implicit operator global::DSE.Open.AsciiString(Tag value)
    {
        return value._value;
    }
    ...
    public static Tag Parse(global::System.ReadOnlySpan<char> s, global::System.IFormatProvider? provider)
        => global::DSE.Open.Values.ValueParser.Parse<Tag, global::DSE.Open.AsciiString>(s, provider);

    public static Tag ParseInvariant(global::System.ReadOnlySpan<char> s)
    ...
    public static bool TryParse(
        ...
        global::System.IFormatProvider? provider,
        out Tag result)
        => global::DSE.Open.Values.ValueParser.TryParse<Tag, global::DSE.Open.AsciiString>(s, provider, out result);
    ...
    public static Tag Parse(string s, global::System.IFormatProvider? provider)
        => global::DSE.Open.Values.ValueParser.Parse<Tag, global::DSE.Open.AsciiString>(s, provider);
    ...
    public static Tag Parse(
        ...
        global::System.IFormatProvider? provider)
        => global::DSE.Open.Values.ValueParser.Parse<Tag, global::DSE.Open.AsciiString>(utf8Source, provider);

    public static bool TryParse(
        global::System.ReadOnlySpan<byte> utf8Source,
        global::System.IFormatProvider? provider,
        out Tag result)
        => global::DSE.Open.Values.ValueParser.TryParse<Tag, global::DSE.Open.AsciiString>(utf8Source, provider, out result);
