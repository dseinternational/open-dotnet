...
[global::System.ComponentModel.TypeConverter(typeof(global::DSE.Open.Values.ValueTypeConverter<Identifier, global::DSE.Open.AsciiString>))]
public readonly partial struct Identifier
{
    private readonly global::DSE.Open.AsciiString _value;

    private Identifier(global::DSE.Open.AsciiString value, bool skipValidation = false)
    {
        if (!skipValidation)
        {
    ...
    private static void EnsureIsValidValue(global::DSE.Open.AsciiString value)
    {
        if (!IsValidValue(value))
        {
            throw new global::System.ArgumentOutOfRangeException(nameof(value), value,
                $"'{value}' is not a valid {nameof(Identifier)} value");
        }
    }

    public static bool TryFromValue(global::DSE.Open.AsciiString value, out Identifier result)
    {
        if (IsValidValue(value))
        {
    ...
    public static Identifier FromValue(global::DSE.Open.AsciiString value)
    {
        EnsureIsValidValue(value);
        return new(value, true);
    }

    public static explicit operator Identifier(global::DSE.Open.AsciiString value)
        => FromValue(value);

    static global::DSE.Open.AsciiString global::DSE.Open.IConvertibleTo<Identifier, global::DSE.Open.AsciiString>.ConvertTo(Identifier value)
        => (global::DSE.Open.AsciiString)value;

    public static implicit operator global::DSE.Open.AsciiString(Identifier value)
    {
        return value._value;
    }
    ...
    public bool Equals(Identifier other) => _value.Equals(other._value);
    ...
    // IEqualityOperators<Identifier, Identifier, bool>
    ...
    /// <summary>
    /// Gets a representation of the Identifier value as a string with default formatting options.
    /// </summary>
    /// <returns>
    ...
    public static Identifier Parse(global::System.ReadOnlySpan<char> s, global::System.IFormatProvider? provider)
        => global::DSE.Open.Values.ValueParser.Parse<Identifier, global::DSE.Open.AsciiString>(s, provider);

    public static Identifier ParseInvariant(global::System.ReadOnlySpan<char> s)
    ...
    public static bool TryParse(
        ...
        => global::DSE.Open.Values.ValueParser.TryParse<Identifier, global::DSE.Open.AsciiString>(s, provider, out result);
    ...
    public static Identifier Parse(string s, global::System.IFormatProvider? provider)
        => global::DSE.Open.Values.ValueParser.Parse<Identifier, global::DSE.Open.AsciiString>(s, provider);

    public static Identifier Parse(string s)
        => Parse(s, default);

    public static Identifier ParseInvariant(string s)
        => Parse(s, global::System.Globalization.CultureInfo.InvariantCulture);
    ...
    public static Identifier Parse(
        ...
        global::System.IFormatProvider? provider)
        => global::DSE.Open.Values.ValueParser.Parse<Identifier, global::DSE.Open.AsciiString>(utf8Source, provider);

    public static bool TryParse(
        global::System.ReadOnlySpan<byte> utf8Source,
        global::System.IFormatProvider? provider,
        out Identifier result)
        => global::DSE.Open.Values.ValueParser.TryParse<Identifier, global::DSE.Open.AsciiString>(utf8Source, provider, out result);
