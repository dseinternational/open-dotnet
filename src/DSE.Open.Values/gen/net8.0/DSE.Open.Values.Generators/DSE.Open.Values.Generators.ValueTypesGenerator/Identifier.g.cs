...
[TypeConverter(typeof(global::DSE.Open.Values.ValueTypeConverter<Identifier, AsciiString>))]
public readonly partial struct Identifier
{
    ...
    private Identifier(AsciiString value, bool skipValidation = false)
    {
    ...
    {
        UninitializedValueException<Identifier, AsciiString>.ThrowIfUninitialized(this);
    }

    public static bool TryFromValue(AsciiString value, out Identifier result)
    {
        if (IsValidValue(value))
        {
    ...
    public static Identifier FromValue(AsciiString value)
    {
        EnsureIsValidArgumentValue(value);
        return new(value, true);
    }

    public static explicit operator Identifier(AsciiString value)
        => FromValue(value);

    static AsciiString global::DSE.Open.IConvertibleTo<Identifier, AsciiString>.ConvertTo(Identifier value)
        => (AsciiString)value;

    public static explicit operator AsciiString(Identifier value)
    {
    ...
    public static bool TryParse(
        ...
        => global::DSE.Open.Values.ValueParser.TryParse<Identifier, AsciiString>(s, provider, out result);
    ...
    public static Identifier Parse(ReadOnlySpan<char> s, IFormatProvider? provider)
        => global::DSE.Open.Values.ValueParser.Parse<Identifier, AsciiString>(s, provider);

    public static Identifier Parse(ReadOnlySpan<char> s)
        => Parse(s, default);

    public static Identifier ParseInvariant(ReadOnlySpan<char> s)
    ...
    public static Identifier ParseInvariant(
        ReadOnlySpan<byte> utf8Source)
    => global::DSE.Open.Values.ValueParser.Parse<Identifier, AsciiString>(utf8Source, System.Globalization.CultureInfo.InvariantCulture);
