...
// Original from: https://github.com/dotnet/efcore/blob/main/src/EFCore/ChangeTracking/ObservableHashSet.cs
...
public class ObservableSet<T> : IObservableSet<T>, IReadOnlyCollection<T>
{
    ...
    public virtual void Clear()
    {
        ...
        OnCollectionChanged(ObservableSetSingletons.NoItems, removed);
    ...
    public virtual void UnionWith(IEnumerable<T> other)
    {
        ...
        OnCollectionChanged(added, ObservableSetSingletons.NoItems);
    ...
    {
        OnPropertyChanged(ObservableSetSingletons.CountPropertyChanged);
    }

    private void OnCountPropertyChanging()
    {
        OnPropertyChanging(ObservableSetSingletons.CountPropertyChanging);
    }
    ...
    private void OnCollectionChanged(System.Collections.IList newItems, System.Collections.IList oldItems)
    {
...
internal static class ObservableSetSingletons
{
