...
{
    /// <summary>
    /// An empty <see cref="ReadOnlySortedValueDictionary{TKey, TValue}"/>.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new, empty <see cref="ReadOnlySortedValueDictionary{TKey, TValue}"/>.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new <see cref="ReadOnlySortedValueDictionary{TKey, TValue}"/> containing the entries of <paramref name="collection"/>.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new <see cref="ReadOnlySortedValueDictionary{TKey, TValue}"/> containing the entries of <paramref name="source"/>.
    /// </summary>
...
#pragma warning disable CA2225 // Operator overloads have named alternates
    ...
    /// <summary>
    /// Creates a <see cref="ReadOnlySortedValueDictionary{TKey, TValue}"/> containing the entries of the specified array.
    /// </summary>
    ...
    /// <summary>
    /// Creates a <see cref="ReadOnlySortedValueDictionary{TKey, TValue}"/> containing the entries of the specified collection.
    /// </summary>
    ...
    /// <summary>
    /// Creates a <see cref="ReadOnlySortedValueDictionary{TKey, TValue}"/> containing the entries of the specified dictionary.
    /// </summary>
