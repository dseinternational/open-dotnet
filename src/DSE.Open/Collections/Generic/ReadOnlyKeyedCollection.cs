    ...
    where TKey : notnull
{
    ...
    public bool Contains(TItem item) => _innerCollection.Contains(item);

    void ICollection<TItem>.CopyTo(TItem[] array, int arrayIndex) => _innerCollection.CopyTo(array, arrayIndex);
    ...
    public IEnumerator<TItem> GetEnumerator() => _innerCollection.GetEnumerator();
    ...
    public bool Contains(TKey key) => _innerCollection.Contains(key);

    public int IndexOf(TItem item) => _innerCollection.IndexOf(item);
    ...
    protected virtual void CopyTo(Array array, int index) => ((ICollection)_innerCollection).CopyTo(array, index);
