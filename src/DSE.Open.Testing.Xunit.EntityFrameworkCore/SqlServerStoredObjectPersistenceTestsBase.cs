...
/// <summary>
/// A SQL Server persistence test base for objects that implement <see cref="IStoredObject"/>,
    ...
    where TEntity : class, IStoredObject
{
    ...
    /// <see cref="SqlServerStoredObjectPersistenceTestsBase{TDbContext, TEntity}"/> class.
    /// </summary>
