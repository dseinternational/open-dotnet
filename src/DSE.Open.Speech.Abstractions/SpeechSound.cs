...
public readonly struct SpeechSound : IEquatable<SpeechSound>, ISpanFormattable, ISpanParsable<SpeechSound>
{
    ...
    /// <param name="c"></param>
    /// <returns></returns>
    /// <remarks>See <see href="https://www.unicode.org/charts/PDF/U0250.pdf"/></remarks>
    public static bool IsIpaExtensionChar(char c)
    {
        return c is >= (char)0x0250 and <= (char)0x02AF;
    }
...
#pragma warning restore CA2225 // Operator overloads have named alternates
    ...
    public static readonly SpeechSound VoicelessBilabialPlosive = new("p", true);
