...
/// <summary>
/// Generates <see cref="ObservationId"/> values safe for use with <c>bigint</c> (<see cref="long"/>) columns.
/// </summary>
public sealed class TemporaryObservationIdValueGenerator : ValueGenerator<ObservationId>
{
