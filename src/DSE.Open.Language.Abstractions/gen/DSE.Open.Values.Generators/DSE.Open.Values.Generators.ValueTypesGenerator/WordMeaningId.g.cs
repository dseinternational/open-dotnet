...
[global::System.ComponentModel.TypeConverter(typeof(global::DSE.Open.Values.ValueTypeConverter<WordMeaningId, ulong>))]
public readonly partial struct WordMeaningId
{
    private readonly ulong _value;

    private WordMeaningId(ulong value, bool skipValidation = false)
    {
        if (!skipValidation)
        {
    ...
    public static bool TryFromValue(ulong value, out WordMeaningId result)
    {
        if (IsValidValue(value))
        {
    ...
    public static WordMeaningId FromValue(ulong value)
    {
        EnsureIsValidValue(value);
        return new(value, true);
    }

    public static explicit operator WordMeaningId(ulong value)
        => FromValue(value);

    static ulong global::DSE.Open.IConvertibleTo<WordMeaningId, ulong>.ConvertTo(WordMeaningId value)
        => (ulong)value;

    public static implicit operator ulong(WordMeaningId value)
    {
        return value._value;
    }
    ...
    public static WordMeaningId Parse(global::System.ReadOnlySpan<char> s, global::System.IFormatProvider? provider)
        => global::DSE.Open.Values.ValueParser.Parse<WordMeaningId, ulong>(s, provider);

    public static WordMeaningId ParseInvariant(global::System.ReadOnlySpan<char> s)
    ...
    public static bool TryParse(
        ...
        => global::DSE.Open.Values.ValueParser.TryParse<WordMeaningId, ulong>(s, provider, out result);
    ...
    public static WordMeaningId Parse(string s, global::System.IFormatProvider? provider)
        => global::DSE.Open.Values.ValueParser.Parse<WordMeaningId, ulong>(s, provider);
    ...
    public static WordMeaningId Parse(
        ...
        global::System.IFormatProvider? provider)
        => global::DSE.Open.Values.ValueParser.Parse<WordMeaningId, ulong>(utf8Source, provider);

    public static bool TryParse(
        global::System.ReadOnlySpan<byte> utf8Source,
        global::System.IFormatProvider? provider,
        out WordMeaningId result)
        => global::DSE.Open.Values.ValueParser.TryParse<WordMeaningId, ulong>(utf8Source, provider, out result);
