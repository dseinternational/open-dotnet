...
[global::System.ComponentModel.TypeConverter(typeof(global::DSE.Open.Values.ValueTypeConverter<YesNo, global::DSE.Open.AsciiString>))]
public readonly partial struct YesNo
{
    private readonly global::DSE.Open.AsciiString _value;

    private YesNo(global::DSE.Open.AsciiString value, bool skipValidation = false)
    {
        if (!skipValidation)
        {
    ...
    public static bool TryFromValue(global::DSE.Open.AsciiString value, out YesNo result)
    {
        if (IsValidValue(value))
        {
    ...
    public static YesNo FromValue(global::DSE.Open.AsciiString value)
    {
        EnsureIsValidValue(value);
        return new(value, true);
    }

    public static explicit operator YesNo(global::DSE.Open.AsciiString value)
        => FromValue(value);

    static global::DSE.Open.AsciiString global::DSE.Open.IConvertibleTo<YesNo, global::DSE.Open.AsciiString>.ConvertTo(YesNo value)
        => (global::DSE.Open.AsciiString)value;

    public static implicit operator global::DSE.Open.AsciiString(YesNo value)
    {
        return value._value;
    }
    ...
    public static YesNo Parse(global::System.ReadOnlySpan<char> s, global::System.IFormatProvider? provider)
        => global::DSE.Open.Values.ValueParser.Parse<YesNo, global::DSE.Open.AsciiString>(s, provider);

    public static YesNo ParseInvariant(global::System.ReadOnlySpan<char> s)
    ...
    public static bool TryParse(
        ...
        global::System.IFormatProvider? provider,
        out YesNo result)
        => global::DSE.Open.Values.ValueParser.TryParse<YesNo, global::DSE.Open.AsciiString>(s, provider, out result);
    ...
    public static YesNo Parse(string s, global::System.IFormatProvider? provider)
        => global::DSE.Open.Values.ValueParser.Parse<YesNo, global::DSE.Open.AsciiString>(s, provider);

    public static YesNo Parse(string s)
        => Parse(s, default);

    public static YesNo ParseInvariant(string s)
        => Parse(s, global::System.Globalization.CultureInfo.InvariantCulture);
    ...
    // IUtf8SpanParsable<YesNo>

    public static YesNo Parse(
        global::System.ReadOnlySpan<byte> utf8Source,
        global::System.IFormatProvider? provider)
        => global::DSE.Open.Values.ValueParser.Parse<YesNo, global::DSE.Open.AsciiString>(utf8Source, provider);

    public static bool TryParse(
        global::System.ReadOnlySpan<byte> utf8Source,
        global::System.IFormatProvider? provider,
        out YesNo result)
        => global::DSE.Open.Values.ValueParser.TryParse<YesNo, global::DSE.Open.AsciiString>(utf8Source, provider, out result);
