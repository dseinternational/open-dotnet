...
public enum MeasureType
{
    ...
    /// <summary>
    /// Gets the type id for an <see cref="IObservation{TValue}"/> with a <see cref="bool"/> value.
    /// </summary>
    [JsonStringEnumMemberName("binary")]
    Binary = 101,

    /// <summary>
    /// Gets the type id for an <see cref="IObservation{TValue, TParam}"/> with a <see cref="bool"/> value
    ...
    /// <summary>
    /// Gets the type id for an <see cref="IObservation{TValue}"/> with a <see cref="Observations.BehaviorFrequency"/> value.
    /// </summary>
    [JsonStringEnumMemberName("behavior_frequency")]
    BehaviorFrequency = 1001,

    /// <summary>
    /// Gets the type id for an <see cref="IObservation{TValue, TParam}"/> with a <see cref="Observations.BehaviorFrequency"/> value
    /// and a <see cref="SpeechSound"/> parameter.
    /// </summary>
    ...
    /// <summary>
    /// Gets the type id for an <see cref="IObservation{TValue}"/> with a <see cref="Observations.Count"/> value.
    /// </summary>
    [JsonStringEnumMemberName("count")]
    Count = 2001,

    /// <summary>
    /// Gets the type id for an <see cref="IObservation{TValue}"/> with an <see cref="Observations.Amount"/> value.
    /// </summary>
    [JsonStringEnumMemberName("amount")]
    Amount = 2010,

    /// <summary>
    /// Gets the type id for an <see cref="IObservation{TValue}"/> with a <see cref="Observations.SpeechClarity"/> value.
    /// </summary>
    [JsonStringEnumMemberName("speech_clarity")]
    SpeechClarity = 3001,

    /// <summary>
    /// Gets the type id for an <see cref="IObservation{TValue, TParam}"/> with a <see cref="Observations.SpeechClarity"/> value
    /// and a <see cref="SpeechSound"/> parameter.
    /// </summary>
    ...
    /// <summary>
    /// Gets the type id for an <see cref="IObservation{TValue}"/> with a <see cref="Observations.Completeness"/> value.
    /// </summary>
    [JsonStringEnumMemberName("completeness")]
    Completeness = 4001,

    /// <summary>
    /// Gets the type id for an <see cref="IObservation{TValue, TParam}"/> with a <see cref="Observations.Completeness"/> value
    /// and a <see cref="SpeechSound"/> parameter.
    /// </summary>
