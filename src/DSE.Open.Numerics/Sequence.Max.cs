...
{
    /// <summary>Returns the maximum value in <paramref name="values"/> using the type's natural ordering.</summary>
    ...
    /// <summary>
    /// Returns the maximum value in <paramref name="values"/>, propagating NaN
