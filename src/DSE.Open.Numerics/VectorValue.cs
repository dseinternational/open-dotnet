...
#pragma warning disable CA1065 // Do not raise exceptions in unexpected locations
        return _kind switch
        {
            ...
            VectorDataType.DateTime => ToDateTime().ToString(),
            VectorDataType.DateTime64 => ToDateTime64().ToString(),
            VectorDataType.DateTimeOffset => ToDateTimeOffset().ToString(),
            VectorDataType.Float16 => ToFloat16().ToString(),
            VectorDataType.Float32 => ToFloat32().ToString(),
            VectorDataType.Float64 => ToFloat64().ToString(),
            VectorDataType.Int16 => ToInt16().ToString(),
            VectorDataType.Int32 => ToInt32().ToString(),
            VectorDataType.Int64 => ToInt64().ToString(),
            VectorDataType.Int8 => ToInt8().ToString(),
            VectorDataType.String => _ref?.ToString() ?? NaValue.NullValueLabel,
            VectorDataType.UInt16 => ToUInt16().ToString(),
            VectorDataType.UInt32 => ToUInt32().ToString(),
            VectorDataType.UInt64 => ToUInt64().ToString(),
            VectorDataType.UInt8 => ToUInt8().ToString(),
