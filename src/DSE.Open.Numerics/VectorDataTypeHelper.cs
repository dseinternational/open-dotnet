...
public static class VectorDataTypeHelper
{
    ...
    private static readonly FrozenDictionary<VectorDataType, Type> s_typeLookup = new Dictionary<VectorDataType, Type>()
    {
        ...
        [VectorDataType.NullableChar] = typeof(NullableValue<char>),
        [VectorDataType.NullableDateTime] = typeof(NullableValue<DateTime>),
        [VectorDataType.NullableDateTime64] = typeof(NullableNumber<DateTime64>),
        [VectorDataType.NullableDateTimeOffset] = typeof(NullableValue<DateTimeOffset>),
        [VectorDataType.NullableFloat32] = typeof(NullableNumber<float>),
        [VectorDataType.NullableFloat64] = typeof(NullableNumber<double>),
        [VectorDataType.NullableUuid] = typeof(NullableValue<Guid>),
