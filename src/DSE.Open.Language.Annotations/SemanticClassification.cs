...
[JsonConverter(typeof(JsonUtf8SpanSerializableValueConverter<SemanticClassification, AsciiString>))]
public readonly partial struct SemanticClassification
    : IEquatableValue<SemanticClassification, AsciiString>,
      IUtf8SpanSerializable<SemanticClassification>
{
    public static int MaxSerializedCharLength => 32;

    public static int MaxSerializedByteLength => 32;

    public SemanticClassification(string value) : this((AsciiString)value)
    {
    }

    private SemanticClassification(string value, bool skipValidation) : this((AsciiString)value, skipValidation)
    {
    }
...
#pragma warning disable CA2225 // Operator overloads have named alternates - Parse
    public static explicit operator SemanticClassification(string value)
#pragma warning restore CA2225 // Operator overloads have named alternates
    ...
    /// </summary>
    public static readonly SemanticClassification AgentAction = new("agent-action", true);

    /// <summary>
    /// Indicates a <b>verb + noun</b> <c>[VERB+(NOUN|PROPN)]</c> (action + object)
    /// construction - for example "throw ball", "drink juice", "washing cat".
    /// </summary>
    public static readonly SemanticClassification ActionObject = new("action-object", true);
    ...
    /// </summary>
    public static readonly SemanticClassification AgentObject = new("agent-object", true);
    ...
    /// </summary>
    public static readonly SemanticClassification PossessorPossession = new("possessor-possession", true);
    ...
    /// </summary>
    public static readonly SemanticClassification AttributeEntity = new("attribute-entity", true);
    ...
    public static readonly SemanticClassification Location = new("location", true);

    /// <summary>
    /// e.g. "sit chair"
    /// </summary>
    public static readonly SemanticClassification ActionLocation = new("action-location", true);

    /// <summary>
    /// e.g. "bear bed"
    /// </summary>
    public static readonly SemanticClassification EntityLocation = new("entity-location", true);
    ...
    /// "eat later".
    /// </summary>
    public static readonly SemanticClassification Temporal = new("temporal", true);

    /// <summary>
    /// Indicates a <b>number + noun</b> <c>[NUM+NOUN]</c> (quantitative)
    /// construction - for example "two balls", "three bags".
    /// </summary>
    public static readonly SemanticClassification Quantitative = new("quantitative", true);
    ...
    /// </summary>
    public static readonly SemanticClassification Conjunctive = new("conjunctive", true);

    /// <summary>
    /// Indicates a <b>determiner + noun</b> <c>DET+NOUN</c> (existence)
    /// construction  - for example, "that ball", "this toy".
    /// </summary>
    public static readonly SemanticClassification DemonstrativeEntity = new("demonstrative-entity", true);
    ...
    /// </summary>
    public static readonly SemanticClassification Recurrence = new("recurrence", true);

    /// <summary>
    /// Non-existence, denial, or rejection of an object or action. "no ball", "no juice", "no eat", "all gone", "no more".
    /// </summary>
    public static readonly SemanticClassification NonExistence = new("non-existence", true);
    ...
    /// construction - for example "dog bark", "baby eat".
    /// </summary>
    public static readonly SemanticClassification AgentActionObject = new("agent-action-object", true);

    /// <summary>
    /// TODO
    /// </summary>
    public static readonly SemanticClassification AgentActionLocation = new("agent-action-location", true);

    /// <summary>
    /// TODO
    /// </summary>
    public static readonly SemanticClassification ActionObjectLocation = new("action-object-location", true);

    // TODO: complete

    public static readonly FrozenSet<SemanticClassification> All = FrozenSet.ToFrozenSet(
    [
        ActionLocation,
        ActionObject,
        AgentAction,
