...
[global::System.ComponentModel.TypeConverter(typeof(global::DSE.Open.Values.ValueTypeConverter<PosTag, global::DSE.Open.AsciiString>))]
public readonly partial struct PosTag
{
    private readonly global::DSE.Open.AsciiString _value;

    private PosTag(global::DSE.Open.AsciiString value, bool skipValidation = false)
    {
        if (!skipValidation)
        {
    ...
    public static bool TryFromValue(global::DSE.Open.AsciiString value, out PosTag result)
    {
        if (IsValidValue(value))
        {
    ...
    public static PosTag FromValue(global::DSE.Open.AsciiString value)
    {
        EnsureIsValidValue(value);
        return new(value, true);
    }

    public static explicit operator PosTag(global::DSE.Open.AsciiString value)
        => FromValue(value);

    static global::DSE.Open.AsciiString global::DSE.Open.IConvertibleTo<PosTag, global::DSE.Open.AsciiString>.ConvertTo(PosTag value)
        => (global::DSE.Open.AsciiString)value;

    public static implicit operator global::DSE.Open.AsciiString(PosTag value)
    {
        return value._value;
    }
    ...
    public static PosTag Parse(global::System.ReadOnlySpan<char> s, global::System.IFormatProvider? provider)
        => global::DSE.Open.Values.ValueParser.Parse<PosTag, global::DSE.Open.AsciiString>(s, provider);

    public static PosTag ParseInvariant(global::System.ReadOnlySpan<char> s)
    ...
    public static bool TryParse(
        ...
        global::System.IFormatProvider? provider,
        out PosTag result)
        => global::DSE.Open.Values.ValueParser.TryParse<PosTag, global::DSE.Open.AsciiString>(s, provider, out result);
    ...
    public static PosTag Parse(string s, global::System.IFormatProvider? provider)
        => global::DSE.Open.Values.ValueParser.Parse<PosTag, global::DSE.Open.AsciiString>(s, provider);
    ...
    public static PosTag Parse(
        ...
        global::System.IFormatProvider? provider)
        => global::DSE.Open.Values.ValueParser.Parse<PosTag, global::DSE.Open.AsciiString>(utf8Source, provider);

    public static bool TryParse(
        global::System.ReadOnlySpan<byte> utf8Source,
        global::System.IFormatProvider? provider,
        out PosTag result)
        => global::DSE.Open.Values.ValueParser.TryParse<PosTag, global::DSE.Open.AsciiString>(utf8Source, provider, out result);
