...
/// timestamps, the <see cref="CreatedUser"/> / <see cref="UpdatedUser"/> identifiers
/// responsible, and a concurrency <see cref="Timestamp"/>.
/// </summary>
/// <remarks>
/// User-tracked counterpart to <see cref="UpdatesTrackedEventRaisingEntity{TId}"/>.
/// Concrete derived types must declare a
/// <see cref="MaterializationConstructorAttribute"/>-marked constructor that chains
/// to <see cref="UpdateUsersTrackedEventRaisingEntity{TId}(TId, DateTimeOffset?, string?, DateTimeOffset?, string?, Timestamp?)"/>;
/// the parameterless and <c>(TId)</c> constructors are the domain-facing 'new entity'
/// paths.
/// </remarks>
public abstract class UpdateUsersTrackedEventRaisingEntity<TId> : EventRaisingEntity<TId>, IUpdateUsersTracked
    where TId : struct, IEquatable<TId>
{
    ...
    /// </summary>
    protected UpdateUsersTrackedEventRaisingEntity()
    {
    }
    ...
    /// </summary>
    protected UpdateUsersTrackedEventRaisingEntity(TId id)
