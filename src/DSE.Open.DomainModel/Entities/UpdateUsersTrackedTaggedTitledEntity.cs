...
/// <summary>
/// An <see cref="UpdateUsersTrackedTitledEntity{TId}"/> that is also externally
/// addressable by a <see cref="Tag"/>.
/// </summary>
/// <remarks>
/// User-tracked counterpart to <see cref="TaggedTitledEntity{TId}"/>.
/// </remarks>
public abstract class UpdateUsersTrackedTaggedTitledEntity<TId> : UpdateUsersTrackedTitledEntity<TId>
    where TId : struct, IEquatable<TId>
{
    ...
    /// </summary>
    protected UpdateUsersTrackedTaggedTitledEntity(Tag tag, string title)
        : base(title)
    {
    ...
    /// </summary>
    protected UpdateUsersTrackedTaggedTitledEntity(TId id, Tag tag, string title)
        : base(id, title)
    {
        EnsureTagNotEmpty(tag);
        _tag = tag;
    ...
    /// </summary>
    protected UpdateUsersTrackedTaggedTitledEntity(
        TId id,
        Tag tag,
        string title,
