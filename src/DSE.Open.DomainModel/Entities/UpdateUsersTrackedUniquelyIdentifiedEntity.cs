...
/// <summary>
/// An <see cref="UpdateUsersTrackedEntity{TId}"/> that also carries a stable, globally
/// unique <see cref="UniqueId"/> alongside its primary key.
/// </summary>
/// <remarks>
/// User-tracked counterpart to <see cref="UniquelyIdentifiedEntity{TId}"/>.
/// </remarks>
/// <typeparam name="TId">The identifier value type.</typeparam>
public abstract class UpdateUsersTrackedUniquelyIdentifiedEntity<TId> : UpdateUsersTrackedEntity<TId>, IUniquelyIdentifiedEntity<TId>
    where TId : struct, IEquatable<TId>
{
    ...
    /// </summary>
    protected UpdateUsersTrackedUniquelyIdentifiedEntity()
        : this(Guid.NewGuid())
    {
    }
    ...
    /// an unset <see cref="Entity{TId}.Id"/>.
    /// </summary>
    protected UpdateUsersTrackedUniquelyIdentifiedEntity(Guid uniqueId)
    {
    ...
    /// </remarks>
    protected UpdateUsersTrackedUniquelyIdentifiedEntity(TId id, Guid uniqueId)
        : base(id)
    {
        EnsureNonEmpty(uniqueId);
        _uniqueId = uniqueId;
