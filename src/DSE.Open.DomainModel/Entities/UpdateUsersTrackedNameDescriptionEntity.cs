...
/// <summary>
/// A user-tracked named entity that also exposes a non-empty <see cref="Description"/>.
/// </summary>
/// <remarks>
/// User-tracked counterpart to <see cref="NameDescriptionEntity{TId}"/>.
/// </remarks>
/// <typeparam name="TId">The identifier value type.</typeparam>
public abstract class UpdateUsersTrackedNameDescriptionEntity<TId> : UpdateUsersTrackedNamedEntity<TId>, IDescribed
    where TId : struct, IEquatable<TId>
{
    ...
    /// </summary>
    protected UpdateUsersTrackedNameDescriptionEntity(string name, string description)
        : base(name)
    {
    ...
    /// description.
    /// </summary>
    protected UpdateUsersTrackedNameDescriptionEntity(TId id, string name, string description)
        : base(id, name)
    {
        ArgumentException.ThrowIfNullOrWhiteSpace(description);
        _description = description;
    ...
    /// </summary>
    protected UpdateUsersTrackedNameDescriptionEntity(
        TId id,
        string name,
        string description,
