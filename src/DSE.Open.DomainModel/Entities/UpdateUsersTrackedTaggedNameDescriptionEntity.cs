...
/// <summary>
/// An <see cref="UpdateUsersTrackedNameDescriptionEntity{TId}"/> that is also
/// externally addressable by a <see cref="Tag"/>.
/// </summary>
/// <remarks>
/// User-tracked counterpart to <see cref="TaggedNameDescriptionEntity{TId}"/>.
/// </remarks>
public abstract class UpdateUsersTrackedTaggedNameDescriptionEntity<TId> : UpdateUsersTrackedNameDescriptionEntity<TId>
    where TId : struct, IEquatable<TId>
{
    ...
    /// </summary>
    protected UpdateUsersTrackedTaggedNameDescriptionEntity(Tag tag, string name, string description)
    ...
    /// </summary>
    protected UpdateUsersTrackedTaggedNameDescriptionEntity(TId id, Tag tag, string name, string description)
    ...
    /// </summary>
    protected UpdateUsersTrackedTaggedNameDescriptionEntity(
        TId id,
        Tag tag,
        string name,
        string description,
